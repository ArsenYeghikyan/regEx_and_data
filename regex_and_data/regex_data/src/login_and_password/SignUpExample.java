...
public final class SignUpExample {
    ...
    private boolean getValidLogin() {
        ...
        Pattern pLogin = Pattern.compile("[a-z]{8,12}", Pattern.CASE_INSENSITIVE);
    ...
    private boolean getValidPassword() {
        ...
        Pattern pPass = Pattern.compile("(?=.*[0-9])(?=.*[!@#$%^&*])(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z!@#$%^&*]{6,18}");
    ...
    private void writeLogAndPassInfo() {
        File f = new File("regex_data/src/login_and_password/loginAndPassword.txt");
